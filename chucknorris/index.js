...
const tracer = initTracer("CHUCKNORRIS");

app.get(('/'),(req, res)=>{
  const span = tracer.startSpan("REQUEST TO GET CHUCKNORRIS");
     res.send("CHUCKNORRIS");
     span.finish();
  })


//Code to make unirest request to get facts of chucknorris
var unirest = require("unirest");

  app.get(('/chucknorris'),(req, res)=>{
    const span = tracer.startSpan("REQUEST TO GET FACT OF CHUCKNORRIS");
